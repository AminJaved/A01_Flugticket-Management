...
public class test extends JFrame{
    ...
    Statement st;	// sending SQL statements to the database
    ResultSet rs;	// contains a table or a part of a table
    
    Statement s2;	// sending SQL statements to the database
    ResultSet rs2;	// contains a table or a part of a table
    ...
    btnSearch.setBounds(423, 129, 182, 33);
    ...
    public void actionPerformed(ActionEvent e) {
    		try {
				...
				// the query checks if there is any flight between the two airports
